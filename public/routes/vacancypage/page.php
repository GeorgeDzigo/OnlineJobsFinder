                  ...
                  <nav class="nav">
                        ...
                        <?php if(count($_SESSION) == 1) { ?>
                              ...
                              <?php if(isset($_SESSION['cmpn_name'])) { ?>
                                    ...
                                    <div class="signout"><a href="<?= $_SERVER['PHP_SELF'].'?tab=signout&id='. $_GET['id']?>">Sign Out</a></div>
                              ...
                              <?php } else if (isset($_SESSION['usr_name'])) {?>
                                    ...
                                    <div class="signout" style='border-radius: 0px 0px 5px 5px'><a href="<?= $_SERVER['PHP_SELF'].'?tab=signout&id='. $_GET['id']?>">Sign Out</a></div>
                              <?php }?>
